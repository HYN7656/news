<template>
  <div class="ca-header">
    <div class="pass">
      <div class="inner-c">
        <a class="words" @click="manager">管理员通道</a>
        <a class="words" @click="backOld">返回旧版</a>
      </div>
    </div>
    <div class="box">
      <div class="inner-c">
...
export default {
  ...
  methods:{
    ...
    backOld(){
      window.open("http://asmc.atmb.net.cn:8002/");
    }
  },
  created() {
...
<style>
  .el-dialog--center .el-dialog__body .hea-p {
    text-align: center;
    line-height: 40px;
    font-weight: 600;
    font-size: 16px;
