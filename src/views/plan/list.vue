  ...
  export default {
    ...
    methods: {
      getPage(){
        ...
        API.get('/ification/findByType', params).then((res) => {
          ...
          if(res.data.code == 200){
            ...
            this.pagId = this.typeList[0].id;
            this.pagName = this.typeList[0].iName;
      ...
      handleSizeChange(val) {
        this.pageSize = val;
        console.log(this.pageFLID)
        console.log(this.pagId)
      ...
      switcher(id,name){
        ...
        params['count'] = this.pageSize;
        // console.log(params);
        API.get('/plan/findAllByrelease', params).then((res) => {
          // console.log(res.data);
          if (res.data.code == 200) {
